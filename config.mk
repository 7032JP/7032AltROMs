...
# 6809 アセンブラ (ツールチェイン)
#   参考書籍および動作観察に基づく代替 ROM 群を 6809 アセンブラからビルドします。
#   推奨: lwtools の lwasm。
AS     = lwasm
...
#     subsys_c : サブ CPU 互換 ROM                    (10240 B)
#   FM77AV 系:
...
#     subsys_a : サブシステム ROM (Type-A の位置。Type-C 相当) (8192 B)
...
#   BASIC インタプリタ本体:
#     7tbasic3 : 7T-BASIC 3.1 (F-BASIC 互換)          (31744 B)
